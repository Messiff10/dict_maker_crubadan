...
with open("/Users/ff/Desktop/测评数据/去空格/ko_chosun_test.txt",'r',encoding='utf-8') as f_in:
    with open("/Users/ff/Desktop/测评数据/去空格/ko_chosun_test_split.txt", 'w', encoding='utf-8') as f_out:
