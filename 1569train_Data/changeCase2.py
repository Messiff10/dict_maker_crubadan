...
s = 'ms_MY'
data_folder = "/Users/ff/Desktop/测评数据/转换小写"
unigram_path = data_folder + '/' + s + '_unigram'  # 词表
file_path2 = data_folder + '/' + s + '_user_no_emoji.txt'  # 原始语料
file_out_path1 = data_folder + '/' + s + '_change.txt'  # 将小写形式在词表，大写不在词表中的词转换成小写
