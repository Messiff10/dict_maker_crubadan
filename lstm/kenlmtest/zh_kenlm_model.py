...
class kenlm_model():
    def __init__(self, save_path='/home/pubsrv/data/original/en_US', project='test2', \
        ...
        self.klm_file = save_path + '/%s.bin' % project  # 语言模型的二进制文件名klm,也可以.bin
    ...
    def read_ngrams(self):
        ...
        """
        # 数据读入
        print("ngram file",self.vocab_file)
...
if __name__ == "__main__":
    ...
    '''
    # 模型加载
    km = kenlm_model(save_path='/home/pubsrv/data/original/en_US', project='test2', \
