import lstm.model_for_test as model_for_test
import tensorflow as tf
import json
from collections import OrderedDict
model = model_for_test.GPT2Model(is_training=False)
sess = tf.Session()
vocab_path = '/home/pubsrv/data/train_data/en_GB/train_data_en_GB_user_web_shuf_case_mapletters_merge'
outputs,targets = model.testlitelm(sess,'en_us_gpt2.tflite',"en_US_huawei_facebook.txt",vocab_path)
